...
private[cli] object RefRepoCli:
    ...
    /** Returns the git toplevel for the current working directory, falling back to the JVM working directory if git is
      * unavailable.
      */
    ...
    /** Resolve the project root, interpret a [[ReferenceRepo]] op against it, and surface any [[RefRepoError]] as a
      * [[RuntimeException]] inside [[Abort]][[[Throwable]]].
      */
